      ...
      `}>
        ...
        <div className="p-3 sm:p-4 md:p-5 lg:p-5 xl:p-5 text-[#465746]">
          ...
          <div className='bg-[#fff]'>
            ...
            <hr />
            <table>
              <th className='font-bold'>Date Absent</th>
              <th className='font-bold'>Date Late</th>
              <td> August 1,2025 </td>
              <td> August 5,2025 </td>
            </table>
          </div>
          ...
          <div>
            <p> Total Days of Present: </p>
            <span> 35 </span>
            <p> Total Days of Late: </p>
            <span> 35 </span>
            <p> Total Days of Absent: </p>
            <span> 35 </span>
          </div>
