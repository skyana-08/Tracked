  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-[#465746] px-6 sm:px-6 lg:px-8 py-6 sm:py-10">
      <div className="bg-[#fff] p-6 sm:p-8 md:p-8 rounded-lg shadow-md w-full max-w-sm text-base sm:text-base">
        ...
        <p className="text-center mb-4 sm:mb-6 md:mb-8 text-base sm:text-base md:text-base">
        ...
        <input
          ...
          pattern="[0-9]*"
          inputMode="numeric"
          className="w-full px-4 sm:px-4 py-2 sm:py-2 border border-gray-300 rounded-md mb-2 sm:mb-2 md:mb-4 focus:outline-none focus:ring-2 focus:ring-[#00A15D] text-sm sm:text-sm"
        />
        ...
        <input
          ...
          required
          className="w-full px-4 sm:px-4 py-2 sm:py-2 border border-gray-300 rounded-md mb-2 sm:mb-3 focus:outline-none focus:ring-2 focus:ring-[#00A15D] text-sm sm:text-sm"
        />

        <p className="text-sm sm:text-sm text-[#00A15D] cursor-pointer mb-3 sm:mb-2 md:mb-4">
          Forgot Password?
        </p>
        ...
        {/* Register link */}
        <div className="text-center mt-3 sm:mt-4 md:mt-6 text-sm sm:text-sm">
