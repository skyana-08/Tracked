...
try {
    ...
    // Get only student accounts
    $stmt = $conn->prepare("SELECT * FROM tracked_users WHERE tracked_Role = 'Student'");
    $stmt->execute();
    $students = $stmt->fetchAll(PDO::FETCH_ASSOC);

    // Generate SQL file content
    $sqlContent = "-- TrackEd Students Backup\n";
    ...
    foreach ($students as $student) {
        ...
        $sqlContent .= "INSERT INTO tracked_users (" . implode(', ', array_keys($student)) . ") ";
